...
import { 
FaUserGraduate,
FaRupeeSign,FaGraduationCap,FaBullseye,
FaCheck,
FaGithub, 
FaVideo,
FaShieldAlt,
...
<aside className="md:col-span-3 order-2 md:order-1">
      ...
      <ul className="space-y-4 text-justify">
        {courses.map((c) => (
          <li key={c.id}>
            <Link
              to={c.route}
              className={`flex flex-col gap-2 w-full rounded-xl border px-3 py-3 transition-colors duration-300
                ${
                  isDark
  ...
  {/* Course Description */}
  <section className="my-8 px-5 md:px-0 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-200 rounded-1xl text-justify p-6">
  ...
  <section className="my-8 px-4 md:px-0 space-y-6 bg-white dark:bg-gray-900 text-gray-900 text-justify dark:text-gray-200 rounded-2xl p-6">
    {/* Header */}
...
<aside className="md:col-span-3 order-3">
  <div className="sticky top-6">
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 space-y-4">
      ...
      {/* Description */}
      <p className="text-gray-700 dark:text-gray-300 text-sm text-justify md:text-base">
        Get the complete details of our <span className="font-semibold text-indigo-600 dark:text-indigo-400">Professional Diploma in Humanoid Robotics for Service Industries</span> course. Learn about modules, curriculum, projects, and career opportunities.
      </p>
